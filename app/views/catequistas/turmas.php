...
<body class="flex bg-[#E5ECFF] h-screen">
    ...
    <main class="flex-1 p-8 overflow-y-auto">
        ...
        <div class="flex flex-col md:flex-row justify-between md:items-center mb-6 gap-4">
            ...
            <a href="/cateclass-site/app/catequista/turmas/nova" class="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg shadow-md hover:bg-blue-700 transition duration-300">
